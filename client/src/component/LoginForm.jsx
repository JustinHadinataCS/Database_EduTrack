      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col mb-6">
          ...
          <input
            ...
            className="form-control p-2 border rounded-md outline-none focus:ring-2 focus:ring-[#3ECF8E] text-black"
        ...
        <div className="flex flex-col mb-6">
          ...
          <input
            ...
            className="form-control p-2 border rounded-md outline-none focus:ring-2 focus:ring-[#3ECF8E]"
